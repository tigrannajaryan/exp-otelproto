...
type Span struct {
	...
	Kind Span_SpanKind `protobuf:"varint,6,opt,name=kind,proto3,enum=experimental2.Span_SpanKind" json:"kind,omitempty"`
...
type Status struct {
	...
	// when not set.
	Code Status_StatusCode `protobuf:"varint,1,opt,name=code,proto3,enum=experimental2.Status_StatusCode" json:"code,omitempty"`
...
type SpanPrepared struct {
	...
	// two spans with the same name may be distinguished using `CLIENT` (caller)
	// and `SERVER` (callee) to identify queueing latency associated with the span.
	Kind SpanPrepared_SpanKind `protobuf:"varint,6,opt,name=kind,proto3,enum=experimental2.SpanPrepared_SpanKind" json:"kind,omitempty"`
...
func init() {
	proto.RegisterEnum("experimental2.Span_SpanKind", Span_SpanKind_name, Span_SpanKind_value)
	proto.RegisterEnum("experimental2.Status_StatusCode", Status_StatusCode_name, Status_StatusCode_value)
	proto.RegisterEnum("experimental2.SpanPrepared_SpanKind", SpanPrepared_SpanKind_name, SpanPrepared_SpanKind_value)
	proto.RegisterType((*ResourceSpans)(nil), "experimental2.ResourceSpans")
	proto.RegisterType((*InstrumentationLibrarySpans)(nil), "experimental2.InstrumentationLibrarySpans")
	proto.RegisterType((*Span)(nil), "experimental2.Span")
	proto.RegisterType((*Span_Event)(nil), "experimental2.Span.Event")
	proto.RegisterType((*Span_Link)(nil), "experimental2.Span.Link")
	proto.RegisterType((*Status)(nil), "experimental2.Status")
	proto.RegisterType((*ResourceSpansPrepared)(nil), "experimental2.ResourceSpansPrepared")
	proto.RegisterType((*SpanPrepared)(nil), "experimental2.SpanPrepared")
}
...
var fileDescriptor_9161fdd1e0292445 = []byte{
	...
	,
}
