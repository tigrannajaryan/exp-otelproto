...
type AnyValue struct {
	...
	AnyValueCustom []AnyValueCustom `protobuf:"bytes,6,rep,name=list_values,json=listValues,proto3,customtype=github.com/tigrannajaryan/exp-otelproto/encodings/otlp_gogo2/common/v1.AnyValueCustom" json:"list_values"`
	KvlistValues   []AttributeKeyValue                                                                     `protobuf:"bytes,7,rep,name=kvlist_values,json=kvlistValues,proto3" json:"kvlist_values"`
...
type AttributeKeyValue struct {
	...
	//  bool bool_value = 6;
	AnyValueCustom AnyValueCustom `protobuf:"bytes,2,opt,name=value,proto3,customtype=github.com/tigrannajaryan/exp-otelproto/encodings/otlp_gogo2/common/v1.AnyValueCustom" json:"value"`
}
...
var fileDescriptor_62ba46dcb97aa817 = []byte{
	...
	,
}
...
func (m *AnyValue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.AnyValueCustom) > 0 {
		for iNdEx := len(m.AnyValueCustom) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.AnyValueCustom[iNdEx].Size()
				i -= size
				if _, err := m.AnyValueCustom[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintCommon(dAtA, i, uint64(size))
			}
...
func (m *AttributeKeyValue) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.AnyValueCustom.Size()
		i -= size
		if _, err := m.AnyValueCustom.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintCommon(dAtA, i, uint64(size))
	}
...
func (m *AnyValue) Size() (n int) {
	...
	if len(m.AnyValueCustom) > 0 {
		for _, e := range m.AnyValueCustom {
			l = e.Size()
			n += 1 + l + sovCommon(uint64(l))
		}
	}
...
func (m *AnyValue) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AnyValueCustom", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AnyValueCustom = append(m.AnyValueCustom, AnyValueCustom{})
			if err := m.AnyValueCustom[len(m.AnyValueCustom)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
...
func (m *AttributeKeyValue) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if err := m.AnyValueCustom.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
