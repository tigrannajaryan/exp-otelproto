...
import (
	...
	v1 "github.com/tigrannajaryan/exp-otelproto/encodings/otlp_gogo3/trace/v1"
...
func init() {
	proto.RegisterType((*ExportTraceServiceRequest)(nil), "opentelemetrygogo3.proto.collector.trace.v1.ExportTraceServiceRequest")
	proto.RegisterType((*ExportTraceServiceResponse)(nil), "opentelemetrygogo3.proto.collector.trace.v1.ExportTraceServiceResponse")
}
...
var fileDescriptor_192a962890318cf4 = []byte{
	...
	,
}
...
func (c *traceServiceClient) Export(ctx context.Context, in *ExportTraceServiceRequest, opts ...grpc.CallOption) (*ExportTraceServiceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/opentelemetrygogo3.proto.collector.trace.v1.TraceService/Export", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TraceService_Export_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/opentelemetrygogo3.proto.collector.trace.v1.TraceService/Export",
	}
...
var _TraceService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "opentelemetrygogo3.proto.collector.trace.v1.TraceService",
