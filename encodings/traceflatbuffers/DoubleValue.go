...
func (rcv *DoubleValue) DoubleValue() float64 {
...
func (rcv *DoubleValue) MutateDoubleValue(n float64) bool {
...
func DoubleValueAddDoubleValue(builder *flatbuffers.Builder, doubleValue float64) {
	builder.PrependFloat64Slot(0, doubleValue, 0.0)
}
