...
func (SeverityNumber) Descriptor() protoreflect.EnumDescriptor {
	return file_logse_proto_enumTypes[0].Descriptor()
}

func (SeverityNumber) Type() protoreflect.EnumType {
	return &file_logse_proto_enumTypes[0]
}
...
func (SeverityNumber) EnumDescriptor() ([]byte, []int) {
	return file_logse_proto_rawDescGZIP(), []int{0}
}
...
func (LogRecordFlags) Descriptor() protoreflect.EnumDescriptor {
	return file_logse_proto_enumTypes[1].Descriptor()
}

func (LogRecordFlags) Type() protoreflect.EnumType {
	return &file_logse_proto_enumTypes[1]
}
...
func (LogRecordFlags) EnumDescriptor() ([]byte, []int) {
	return file_logse_proto_rawDescGZIP(), []int{1}
}
...
type ResourceLogs struct {
	...
	InstrumentationLibraryLogs []*InstrumentationLibraryLogs `protobuf:"bytes,2,rep,name=instrumentation_library_logs,json=i,proto3" json:"instrumentation_library_logs,omitempty"`
}

func (x *ResourceLogs) Reset() {
	*x = ResourceLogs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_logse_proto_msgTypes[0]
...
type InstrumentationLibraryLogs struct {
	...
	Logs []*LogRecord `protobuf:"bytes,2,rep,name=logs,json=l,proto3" json:"logs,omitempty"`
}

func (x *InstrumentationLibraryLogs) Reset() {
	*x = InstrumentationLibraryLogs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_logse_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
type LogRecord struct {
	...
	// [Optional].
	SeverityNumber SeverityNumber `protobuf:"varint,2,opt,name=severity_number,json=sn,proto3,enum=experimental.SeverityNumber" json:"severity_number,omitempty"`
	...
	Body *AnyValue `protobuf:"bytes,5,opt,name=body,json=b,proto3" json:"body,omitempty"`
	// Additional attributes that describe the specific event occurrence. [Optional].
	Attributes             []*KeyValue `protobuf:"bytes,6,rep,name=attributes,json=a,proto3" json:"attributes,omitempty"`
...
func (x *LogRecord) Reset() {
	*x = LogRecord{}
	if protoimpl.UnsafeEnabled {
		mi := &file_logse_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LogRecord) Descriptor() ([]byte, []int) {
	return file_logse_proto_rawDescGZIP(), []int{2}
}
...
var File_logse_proto protoreflect.FileDescriptor

var file_logse_proto_rawDesc = []byte{
	,
	...
	0x72, 0x61, 0x72, 0x79, 0x4c, 0x6f, 0x67, 0x73, 0x52, 0x01, 0x69, 0x22, 0x90, 0x01, 0x0a, 0x1a,
	0x49, 0x6e, 0x73, 0x74, 0x72, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x4c,
	0x69, 0x62, 0x72, 0x61, 0x72, 0x79, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x48, 0x0a, 0x17, 0x69, 0x6e,
	0x73, 0x74, 0x72, 0x75, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6c, 0x69,
	0x62, 0x72, 0x61, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x65, 0x78,
	...
	,
	...
	0x0a, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x02, 0x73, 0x69, 0x2a, 0xc3, 0x05, 0x0a, 0x0e, 0x53, 0x65,
	...
	0x58, 0x0a, 0x0e, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x46, 0x6c, 0x61, 0x67,
	...
	0x10, 0x00, 0x12, 0x25, 0x0a, 0x20, 0x4c, 0x4f, 0x47, 0x5f, 0x52, 0x45, 0x43, 0x4f, 0x52, 0x44,
	0x5f, 0x46, 0x4c, 0x41, 0x47, 0x5f, 0x54, 0x52, 0x41, 0x43, 0x45, 0x5f, 0x46, 0x4c, 0x41, 0x47,
	0x53, 0x5f, 0x4d, 0x41, 0x53, 0x4b, 0x10, 0xff, 0x01, 0x42, 0x45, 0x0a, 0x1e, 0x69, 0x6f, 0x2e,
	...
	0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x16, 0x65, 0x6e, 0x63, 0x6f, 0x64, 0x69,
	0x6e, 0x67, 0x73, 0x2f, 0x65, 0x78, 0x70, 0x65, 0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_logse_proto_rawDescOnce sync.Once
	file_logse_proto_rawDescData = file_logse_proto_rawDesc
)

func file_logse_proto_rawDescGZIP() []byte {
	file_logse_proto_rawDescOnce.Do(func() {
		file_logse_proto_rawDescData = protoimpl.X.CompressGZIP(file_logse_proto_rawDescData)
	})
	return file_logse_proto_rawDescData
}

var file_logse_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_logse_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_logse_proto_goTypes = []interface{}{
	...
	(*InstrumentationLibraryLogs)(nil), // 3: experimental.InstrumentationLibraryLogs
	(*LogRecord)(nil),                  // 4: experimental.LogRecord
	(*Resource)(nil),                   // 5: experimental.Resource
	(*InstrumentationLibrary)(nil),     // 6: experimental.InstrumentationLibrary
	(*AnyValue)(nil),                   // 7: experimental.AnyValue
	(*KeyValue)(nil),                   // 8: experimental.KeyValue
}
var file_logse_proto_depIdxs = []int32{
	5, // 0: experimental.ResourceLogs.resource:type_name -> experimental.Resource
	3, // 1: experimental.ResourceLogs.instrumentation_library_logs:type_name -> experimental.InstrumentationLibraryLogs
	6, // 2: experimental.InstrumentationLibraryLogs.instrumentation_library:type_name -> experimental.InstrumentationLibrary
	4, // 3: experimental.InstrumentationLibraryLogs.logs:type_name -> experimental.LogRecord
	0, // 4: experimental.LogRecord.severity_number:type_name -> experimental.SeverityNumber
	7, // 5: experimental.LogRecord.body:type_name -> experimental.AnyValue
	8, // 6: experimental.LogRecord.attributes:type_name -> experimental.KeyValue
...
func init() { file_logse_proto_init() }
func file_logse_proto_init() {
	if File_logse_proto != nil {
		return
	}
	file_commone_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_logse_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_logse_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_logse_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_logse_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_logse_proto_goTypes,
		DependencyIndexes: file_logse_proto_depIdxs,
		EnumInfos:         file_logse_proto_enumTypes,
		MessageInfos:      file_logse_proto_msgTypes,
	}.Build()
	File_logse_proto = out.File
	file_logse_proto_rawDesc = nil
	file_logse_proto_goTypes = nil
	file_logse_proto_depIdxs = nil
}
