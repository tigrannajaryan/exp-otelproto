...
func (Span_TimeEvent_MessageEvent_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 2, 1, 0}
}
...
func (Span_Link_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 4, 0}
}
...
func (*Span_Tracestate_Entry) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 0, 0}
}
...
func (*Span_TimeEvent_Annotation) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 2, 0}
}
...
func (*Span_TimeEvent_MessageEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{0, 2, 1}
}
...
func (*StackTrace_StackFrames) Descriptor() ([]byte, []int) {
	return fileDescriptor_0571941a1d628a80, []int{3, 1}
}
...
var fileDescriptor_0571941a1d628a80 = []byte{
	...
	,
}
